...
class Users {
  ...
  Map<String, dynamic> toJson() {
    ...
    if (hair != null) data['hair'] = hair!.toJson();
    data['ip'] = ip;
    if (address != null) data['address'] = address!.toJson();
    data['macAddress'] = macAddress;
    data['university'] = university;
    if (bank != null) data['bank'] = bank!.toJson();
    if (company != null) data['company'] = company!.toJson();
    data['ein'] = ein;
    data['ssn'] = ssn;
    data['userAgent'] = userAgent;
    if (crypto != null) data['crypto'] = crypto!.toJson();
    data['role'] = role;
    return data;
  }
}
...
class Bank {
  ...
  Map<String, dynamic> toJson() {
    return {'cardExpire': cardExpire, 'cardNumber': cardNumber, 'cardType': cardType, 'currency': currency, 'iban': iban};
  }
}
